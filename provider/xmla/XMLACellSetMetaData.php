...
// Interfaces
use OLAP4PHP\OLAP\ICellSetMetaData;
...
/**
 * @brief XMLA ICellSetMetaData Implementation
 */
class XMLACellSetMetaData implements ICellSetMetaData
{
   private $cube;
   private $filterAxisMetaData;
   private $axisMetaDataList;
   // string => IProperty
   private $propertiesByTag;
